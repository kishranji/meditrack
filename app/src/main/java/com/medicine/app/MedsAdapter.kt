...
class MedsAdapter(val mList: List<medicine_entity>, val mCallBack: MedClick) :
    RecyclerView.Adapter<MedsAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.inflate_med_adapter, parent, false)
        return ViewHolder(v);
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val mDeleteImage: ImageView = itemView.findViewById(R.id.delete)
