...
class DashboardActivity : AppCompatActivity(), ItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = CommonAdapter(names, res, this)
        rv.adapter = adapter

        sell_btn.setOnClickListener {
            startActivity(Intent(this, SellMeds::class.java))
        }

        buy_btn.setOnClickListener {
            startActivity(Intent(this, BuyMeds::class.java))
        }
    }
